...
<body>
    ...
    <center>
        <h2 style= bgcolor="white">Form Cetak Nilai Siswa<br></h2>

        <table border="1" bgcolor="gray" cellpadding="2">
            <?php
            ...
            ?> 
             ...
             <br>
             <br>
             <input type="submit" name="submit" value="KEMBALI" data-toggle="collapse"data-target=".bs-navbar-collapse"/>
</body>   
</html>